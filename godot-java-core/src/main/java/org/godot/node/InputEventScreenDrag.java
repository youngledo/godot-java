...
public class InputEventScreenDrag extends InputEventFromWindow {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			java.util.Map.entry("get_index", 3905245786L), java.util.Map.entry("set_pressure", 373806689L),
			java.util.Map.entry("get_pressure", 1740695150L), java.util.Map.entry("set_position", 743155724L),
			java.util.Map.entry("get_position", 3341600327L), java.util.Map.entry("set_relative", 743155724L),
			java.util.Map.entry("get_relative", 3341600327L), java.util.Map.entry("set_tilt", 743155724L),
			java.util.Map.entry("set_screen_velocity", 743155724L),
			java.util.Map.entry("get_screen_relative", 3341600327L), java.util.Map.entry("set_index", 1286410249L),
			java.util.Map.entry("set_velocity", 743155724L), java.util.Map.entry("get_velocity", 3341600327L),
			java.util.Map.entry("get_pen_inverted", 36873697L), java.util.Map.entry("get_tilt", 3341600327L),
			java.util.Map.entry("get_screen_velocity", 3341600327L),
			java.util.Map.entry("set_screen_relative", 743155724L),
			java.util.Map.entry("set_pen_inverted", 2586408642L));

	InputEventScreenDrag(MemorySegment nativePointer) {
		super(nativePointer);
	}

	InputEventScreenDrag(long nativePointer) {
		super(nativePointer);
	}
