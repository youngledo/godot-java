...
public class NavigationPathQueryParameters3D extends RefCounted {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			...
			java.util.Map.entry("get_start_position", 3360562783L),
			...
			java.util.Map.entry("get_metadata_flags", 1582332802L),
			...
			java.util.Map.entry("set_start_position", 3460891852L),
			java.util.Map.entry("set_metadata_flags", 2713846708L),
	...
	NavigationPathQueryParameters3D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	NavigationPathQueryParameters3D(long nativePointer) {
		super(nativePointer);
	}
