...
public class CPUParticles3D extends GeometryInstance3D {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			...
			java.util.Map.entry("get_scale_curve_z", 2460114913L),
			...
			java.util.Map.entry("capture_aabb", 1068685055L), java.util.Map.entry("set_particle_flag", 3515406498L),
			...
			java.util.Map.entry("set_draw_order", 1427401774L), java.util.Map.entry("set_scale_curve_x", 270443179L),
			java.util.Map.entry("get_emission_box_extents", 3360562783L),
			java.util.Map.entry("set_scale_curve_y", 270443179L), java.util.Map.entry("set_direction", 3460891852L),
			java.util.Map.entry("get_direction", 3360562783L), java.util.Map.entry("set_use_fixed_seed", 2586408642L),
			java.util.Map.entry("set_scale_curve_z", 270443179L),
			...
			java.util.Map.entry("get_fractional_delta", 36873697L), java.util.Map.entry("get_param_max", 597646162L),
			java.util.Map.entry("get_emission_sphere_radius", 1740695150L),
			java.util.Map.entry("get_gravity", 3360562783L), java.util.Map.entry("set_flatness", 373806689L),
			java.util.Map.entry("set_emitting", 2586408642L), java.util.Map.entry("get_draw_order", 1321900776L),
			java.util.Map.entry("get_use_fixed_seed", 36873697L),
			java.util.Map.entry("set_emission_ring_height", 373806689L),
			java.util.Map.entry("get_emission_shape", 2961454842L),
			...
			java.util.Map.entry("get_fixed_fps", 3905245786L), java.util.Map.entry("set_param_curve", 4044142537L),
			java.util.Map.entry("get_particle_flag", 2845201987L),
			...
			java.util.Map.entry("set_param_max", 557936109L), java.util.Map.entry("get_one_shot", 36873697L),
			java.util.Map.entry("get_randomness_ratio", 1740695150L), java.util.Map.entry("get_flatness", 1740695150L),
			java.util.Map.entry("get_color", 3444240500L), java.util.Map.entry("set_emission_shape", 491823814L),
			java.util.Map.entry("set_emission_box_extents", 3460891852L),
			java.util.Map.entry("set_param_min", 557936109L), java.util.Map.entry("get_emission_points", 497664490L),
			java.util.Map.entry("get_param_curve", 4132790277L), java.util.Map.entry("get_param_min", 597646162L),
			java.util.Map.entry("set_emission_points", 334873810L), java.util.Map.entry("get_spread", 1740695150L),
			...
			java.util.Map.entry("set_emission_normals", 334873810L),
			...
			java.util.Map.entry("set_gravity", 3460891852L), java.util.Map.entry("get_pre_process_time", 1740695150L),
			java.util.Map.entry("get_emission_ring_inner_radius", 1740695150L),
			java.util.Map.entry("set_lifetime", 373806689L), java.util.Map.entry("set_mesh", 194775623L),
			java.util.Map.entry("get_emission_ring_axis", 3360562783L), java.util.Map.entry("get_mesh", 1808005922L),
			java.util.Map.entry("get_color_initial_ramp", 132272999L),
			java.util.Map.entry("get_emission_normals", 497664490L), java.util.Map.entry("set_one_shot", 2586408642L),
			java.util.Map.entry("get_lifetime_randomness", 1740695150L),
			java.util.Map.entry("set_emission_colors", 3546319833L));

	CPUParticles3D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	CPUParticles3D(long nativePointer) {
		super(nativePointer);
	}
	...
	public Curve getScale_curve_z() {
		return (Curve) super.call("get_scale_curve_z", new java.lang.Object[0]);
	}

	public void setScale_curve_z(Curve value) {
		super.call("set_scale_curve_z", new java.lang.Object[]{(java.lang.Object) value});
	}
