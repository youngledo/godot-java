...
public class GPUParticlesAttractorSphere3D extends GPUParticlesAttractor3D {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map
			.ofEntries(java.util.Map.entry("get_radius", 1740695150L), java.util.Map.entry("set_radius", 373806689L));

	GPUParticlesAttractorSphere3D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	GPUParticlesAttractorSphere3D(long nativePointer) {
		super(nativePointer);
	}
