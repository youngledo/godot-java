...
public class GPUParticlesAttractorBox3D extends GPUParticlesAttractor3D {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map
			.ofEntries(java.util.Map.entry("set_size", 3460891852L), java.util.Map.entry("get_size", 3360562783L));

	GPUParticlesAttractorBox3D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	GPUParticlesAttractorBox3D(long nativePointer) {
		super(nativePointer);
	}
