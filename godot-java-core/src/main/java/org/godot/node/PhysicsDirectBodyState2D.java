...
public class PhysicsDirectBodyState2D extends Godot {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			java.util.Map.entry("get_constant_force", 3341600327L), java.util.Map.entry("set_sleep_state", 2586408642L),
			...
			java.util.Map.entry("get_velocity_at_local_position", 2656412154L),
			java.util.Map.entry("get_step", 1740695150L), java.util.Map.entry("add_constant_force", 4288681949L),
			java.util.Map.entry("get_contact_collider", 495598643L),
			java.util.Map.entry("get_total_gravity", 3341600327L),
			java.util.Map.entry("get_contact_local_position", 2299179447L),
			java.util.Map.entry("get_inverse_inertia", 1740695150L),
			java.util.Map.entry("get_contact_local_normal", 2299179447L),
			java.util.Map.entry("apply_central_impulse", 743155724L),
			java.util.Map.entry("get_collision_mask", 3905245786L),
			java.util.Map.entry("set_linear_velocity", 743155724L),
			java.util.Map.entry("set_collision_mask", 1286410249L),
			java.util.Map.entry("get_linear_velocity", 3341600327L),
			java.util.Map.entry("get_contact_impulse", 2299179447L),
			java.util.Map.entry("add_constant_torque", 373806689L), java.util.Map.entry("set_transform", 2761652528L),
			java.util.Map.entry("get_space_state", 2506717822L), java.util.Map.entry("apply_force", 4288681949L),
			...
			java.util.Map.entry("integrate_forces", 3218959716L), java.util.Map.entry("get_transform", 3814499831L),
			java.util.Map.entry("get_contact_collider_object", 3332903315L),
			java.util.Map.entry("get_angular_velocity", 1740695150L),
			...
			java.util.Map.entry("get_contact_collider_position", 2299179447L),
			java.util.Map.entry("set_angular_velocity", 373806689L),
			java.util.Map.entry("apply_torque_impulse", 373806689L),
			java.util.Map.entry("get_total_linear_damp", 1740695150L),
			java.util.Map.entry("get_center_of_mass_local", 3341600327L), java.util.Map.entry("is_sleeping", 36873697L),
			java.util.Map.entry("apply_central_force", 3862383994L),
			java.util.Map.entry("get_total_angular_damp", 1740695150L),
			java.util.Map.entry("get_inverse_mass", 1740695150L),
			java.util.Map.entry("add_constant_central_force", 3862383994L),
			java.util.Map.entry("apply_impulse", 4288681949L), java.util.Map.entry("apply_torque", 373806689L),
			java.util.Map.entry("get_contact_local_velocity_at_position", 2299179447L),
			java.util.Map.entry("get_contact_collider_id", 923996154L),
			java.util.Map.entry("get_contact_collider_velocity_at_position", 2299179447L));

	PhysicsDirectBodyState2D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	PhysicsDirectBodyState2D(long nativePointer) {
		super(nativePointer);
	}

	public Vector2 get_velocity_at_local_position(Vector2 local_position) {
		return (Vector2) super.call("get_velocity_at_local_position",
	...
	public void apply_torque_impulse(double impulse) {
		super.call("apply_torque_impulse", new java.lang.Object[]{java.lang.Double.valueOf(impulse)});
	}
	...
	public Vector2 get_contact_local_velocity_at_position(long contact_idx) {
		return (Vector2) super.call("get_contact_local_velocity_at_position",
				new java.lang.Object[]{java.lang.Long.valueOf(contact_idx)});
	}
	...
	public Vector2 get_contact_collider_position(long contact_idx) {
		return (Vector2) super.call("get_contact_collider_position",
				new java.lang.Object[]{java.lang.Long.valueOf(contact_idx)});
	}
	...
	public Vector2 get_contact_collider_velocity_at_position(long contact_idx) {
		return (Vector2) super.call("get_contact_collider_velocity_at_position",
				new java.lang.Object[]{java.lang.Long.valueOf(contact_idx)});
	}

	public Vector2 get_contact_impulse(long contact_idx) {
		return (Vector2) super.call("get_contact_impulse", new java.lang.Object[]{java.lang.Long.valueOf(contact_idx)});
	}
	...
	public double getInverse_inertia() {
		return (double) super.call("get_inverse_inertia", new java.lang.Object[0]);
	}

	public void setInverse_inertia(double value) {
		super.call("set_inverse_inertia", new java.lang.Object[]{java.lang.Double.valueOf(value)});
	}
	...
	public Vector2 getTotal_gravity() {
		return (Vector2) super.call("get_total_gravity", new java.lang.Object[0]);
	}

	public void setTotal_gravity(Vector2 value) {
	...
	public Vector2 getCenter_of_mass_local() {
		return (Vector2) super.call("get_center_of_mass_local", new java.lang.Object[0]);
	}

	public void setCenter_of_mass_local(Vector2 value) {
