...
public class AnimatedSprite3D extends SpriteBase3D {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			java.util.Map.entry("play", 3269405555L), java.util.Map.entry("get_animation", 2002593661L),
			java.util.Map.entry("get_sprite_frames", 3804851214L), java.util.Map.entry("set_autoplay", 83702148L),
			java.util.Map.entry("get_autoplay", 201670096L), java.util.Map.entry("get_frame", 3905245786L),
			java.util.Map.entry("set_frame", 1286410249L), java.util.Map.entry("set_speed_scale", 373806689L),
			java.util.Map.entry("set_frame_and_progress", 1602489585L), java.util.Map.entry("pause", 3218959716L),
			java.util.Map.entry("set_sprite_frames", 905781144L), java.util.Map.entry("set_frame_progress", 373806689L),
			java.util.Map.entry("play_backwards", 3323268493L), java.util.Map.entry("stop", 3218959716L),
	...
	AnimatedSprite3D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	AnimatedSprite3D(long nativePointer) {
		super(nativePointer);
	}
