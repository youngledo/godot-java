...
public class NavigationLink2D extends Node2D {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			java.util.Map.entry("set_travel_cost", 373806689L),
			java.util.Map.entry("get_global_end_position", 3341600327L),
			...
			java.util.Map.entry("set_global_start_position", 743155724L),
			java.util.Map.entry("get_navigation_map", 2944877500L),
			java.util.Map.entry("get_start_position", 3341600327L), java.util.Map.entry("get_rid", 2944877500L),
			...
			java.util.Map.entry("set_end_position", 743155724L),
			java.util.Map.entry("get_global_start_position", 3341600327L),
			java.util.Map.entry("set_navigation_layers", 1286410249L),
			java.util.Map.entry("get_end_position", 3341600327L),
			java.util.Map.entry("get_navigation_layer_value", 1116898809L),
			java.util.Map.entry("set_global_end_position", 743155724L),
			java.util.Map.entry("is_bidirectional", 36873697L), java.util.Map.entry("set_start_position", 743155724L),
			java.util.Map.entry("get_navigation_layers", 3905245786L),
			java.util.Map.entry("set_navigation_layer_value", 300928843L));

	NavigationLink2D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	NavigationLink2D(long nativePointer) {
		super(nativePointer);
	}
	...
	public Vector2 getEnd_position() {
		return (Vector2) super.call("get_end_position", new java.lang.Object[0]);
	}

	public void setEnd_position(Vector2 value) {
