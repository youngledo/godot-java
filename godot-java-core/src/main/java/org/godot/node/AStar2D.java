...
public class AStar2D extends RefCounted {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			...
			java.util.Map.entry("get_closest_point", 2300324924L), java.util.Map.entry("connect_points", 3710494224L),
			...
			java.util.Map.entry("get_closest_position_in_segment", 2656412154L),
			java.util.Map.entry("set_neighbor_filter_enabled", 2586408642L),
			java.util.Map.entry("get_id_path", 3136199648L), java.util.Map.entry("get_point_position", 2299179447L),
			java.util.Map.entry("remove_point", 1286410249L),
			java.util.Map.entry("is_neighbor_filter_enabled", 36873697L), java.util.Map.entry("add_point", 4074201818L),
			java.util.Map.entry("set_point_position", 163021252L), java.util.Map.entry("get_point_path", 3427490392L));

	AStar2D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	AStar2D(long nativePointer) {
		super(nativePointer);
	}
	...
	public Vector2 get_point_position(long id) {
		return (Vector2) super.call("get_point_position", new java.lang.Object[]{java.lang.Long.valueOf(id)});
	}
	...
	public long get_closest_point(Vector2 to_position, boolean include_disabled) {
	...
	public Vector2 get_closest_position_in_segment(Vector2 to_position) {
		return (Vector2) super.call("get_closest_position_in_segment",
