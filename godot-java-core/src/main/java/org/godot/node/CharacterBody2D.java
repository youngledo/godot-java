...
public class CharacterBody2D extends PhysicsBody2D {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			...
			java.util.Map.entry("is_on_ceiling_only", 36873697L), java.util.Map.entry("get_motion_mode", 1160151236L),
			java.util.Map.entry("get_slide_collision", 860659811L), java.util.Map.entry("move_and_slide", 2240911060L),
			java.util.Map.entry("set_motion_mode", 1224392233L), java.util.Map.entry("set_safe_margin", 373806689L),
			java.util.Map.entry("set_floor_snap_length", 373806689L), java.util.Map.entry("is_on_ceiling", 36873697L),
			java.util.Map.entry("get_position_delta", 3341600327L),
			java.util.Map.entry("set_platform_floor_layers", 1286410249L),
			java.util.Map.entry("get_safe_margin", 1740695150L),
			java.util.Map.entry("get_last_slide_collision", 2161834755L), java.util.Map.entry("is_on_floor", 36873697L),
			java.util.Map.entry("is_floor_stop_on_slope_enabled", 36873697L),
			java.util.Map.entry("set_floor_max_angle", 373806689L), java.util.Map.entry("set_up_direction", 743155724L),
			java.util.Map.entry("is_on_floor_only", 36873697L),
			java.util.Map.entry("get_platform_wall_layers", 3905245786L),
			java.util.Map.entry("get_wall_normal", 3341600327L), java.util.Map.entry("set_max_slides", 1286410249L),
			java.util.Map.entry("get_up_direction", 3341600327L),
			java.util.Map.entry("set_platform_wall_layers", 1286410249L),
			java.util.Map.entry("get_floor_angle", 2841063350L),
			...
			java.util.Map.entry("get_floor_normal", 3341600327L),
			java.util.Map.entry("set_slide_on_ceiling_enabled", 2586408642L),
			java.util.Map.entry("set_platform_on_leave", 2423324375L),
			java.util.Map.entry("get_wall_min_slide_angle", 1740695150L),
			java.util.Map.entry("get_platform_velocity", 3341600327L),
			...
			java.util.Map.entry("apply_floor_snap", 3218959716L),
			java.util.Map.entry("set_wall_min_slide_angle", 373806689L),
			java.util.Map.entry("get_platform_on_leave", 4054324341L),
			java.util.Map.entry("get_real_velocity", 3341600327L), java.util.Map.entry("get_max_slides", 3905245786L),
			java.util.Map.entry("get_last_motion", 3341600327L));

	CharacterBody2D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	CharacterBody2D(long nativePointer) {
		super(nativePointer);
	}
	...
	public KinematicCollision2D get_slide_collision(long slide_idx) {
		return (KinematicCollision2D) super.call("get_slide_collision",
	...
	public Vector2 getUp_direction() {
		return (Vector2) super.call("get_up_direction", new java.lang.Object[0]);
	}

	public void setUp_direction(Vector2 value) {
