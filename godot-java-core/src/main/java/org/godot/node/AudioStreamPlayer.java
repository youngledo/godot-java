...
public class AudioStreamPlayer extends Node {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			java.util.Map.entry("play", 1958160172L), java.util.Map.entry("get_mix_target", 172807476L),
			java.util.Map.entry("get_max_polyphony", 3905245786L),
			java.util.Map.entry("get_playback_position", 191475506L),
			java.util.Map.entry("get_volume_linear", 1740695150L), java.util.Map.entry("set_playback_type", 725473817L),
			java.util.Map.entry("seek", 373806689L), java.util.Map.entry("set_playing", 2586408642L),
			java.util.Map.entry("get_volume_db", 1740695150L), java.util.Map.entry("get_stream", 160907539L),
			java.util.Map.entry("get_stream_paused", 36873697L), java.util.Map.entry("set_mix_target", 2300306138L),
			java.util.Map.entry("set_max_polyphony", 1286410249L),
			java.util.Map.entry("has_stream_playback", 2240911060L),
			java.util.Map.entry("is_autoplay_enabled", 36873697L), java.util.Map.entry("is_playing", 36873697L),
			...
			java.util.Map.entry("set_pitch_scale", 373806689L), java.util.Map.entry("set_volume_linear", 373806689L),
			java.util.Map.entry("stop", 3218959716L), java.util.Map.entry("set_stream", 2210767741L),
			java.util.Map.entry("set_bus", 3304788590L));

	AudioStreamPlayer(MemorySegment nativePointer) {
		super(nativePointer);
	}

	AudioStreamPlayer(long nativePointer) {
		super(nativePointer);
	}
	...
	public long getMix_target() {
		return (long) super.call("get_mix_target", new java.lang.Object[0]);
	}

	public void setMix_target(long value) {
		super.call("set_mix_target", new java.lang.Object[]{java.lang.Long.valueOf(value)});
	}
