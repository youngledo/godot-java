...
public class NavigationAgent3D extends Node {
	private static final Map<String, Long> METHOD_HASHES = java.util.Map.ofEntries(
			...
			java.util.Map.entry("set_keep_y_velocity", 2586408642L),
			java.util.Map.entry("set_path_metadata_flags", 2713846708L),
			...
			java.util.Map.entry("get_debug_use_custom", 36873697L), java.util.Map.entry("get_height", 1740695150L),
			java.util.Map.entry("get_path_height_offset", 1740695150L),
			...
			java.util.Map.entry("get_pathfinding_algorithm", 3398491350L),
			java.util.Map.entry("get_avoidance_layers", 3905245786L),
			java.util.Map.entry("get_final_position", 3783033775L),
			...
			java.util.Map.entry("get_velocity", 3783033775L),
			java.util.Map.entry("get_avoidance_priority", 1740695150L),
			java.util.Map.entry("get_max_speed", 1740695150L),
			java.util.Map.entry("get_current_navigation_result", 728825684L),
			...
			java.util.Map.entry("set_pathfinding_algorithm", 394560454L),
			...
			java.util.Map.entry("set_target_position", 3460891852L),
			...
			java.util.Map.entry("get_path_metadata_flags", 1582332802L),
			java.util.Map.entry("get_current_navigation_path", 497664490L),
			java.util.Map.entry("set_simplify_path", 2586408642L),
			java.util.Map.entry("set_path_height_offset", 373806689L),
			java.util.Map.entry("get_time_horizon_obstacles", 1740695150L),
			java.util.Map.entry("set_max_speed", 373806689L),
			java.util.Map.entry("get_next_path_position", 3783033775L),
			...
			java.util.Map.entry("get_path_postprocessing", 3883858360L),
			...
			java.util.Map.entry("set_path_postprocessing", 2267362344L),
			...
			java.util.Map.entry("set_velocity_forced", 3460891852L), java.util.Map.entry("set_velocity", 3460891852L),
			java.util.Map.entry("get_keep_y_velocity", 36873697L),
	...
	NavigationAgent3D(MemorySegment nativePointer) {
		super(nativePointer);
	}

	NavigationAgent3D(long nativePointer) {
		super(nativePointer);
	}
	...
	public double getPath_height_offset() {
		return (double) super.call("get_path_height_offset", new java.lang.Object[0]);
	}

	public void setPath_height_offset(double value) {
		super.call("set_path_height_offset", new java.lang.Object[]{java.lang.Double.valueOf(value)});
	}
	...
	public boolean getKeep_y_velocity() {
		return (boolean) super.call("get_keep_y_velocity", new java.lang.Object[0]);
	}

	public void setKeep_y_velocity(boolean value) {
		super.call("set_keep_y_velocity", new java.lang.Object[]{java.lang.Boolean.valueOf(value)});
	}
